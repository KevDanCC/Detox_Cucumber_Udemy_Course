...
When('I verify that the first image of Asia row exist', async()=>{
...
Then('I virify that the last image of the row is not visible', async()=>{
    await expect(element(by.id('image-europe-2'))).toBeNotVisible();
})