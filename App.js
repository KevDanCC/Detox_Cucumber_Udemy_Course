...
homeFlow.navigationOptions = {
  title: 'Home',
  tabBarIcon: <FontAwesome5 name="home" size={20} testID='homeNavigationImagen'/>,
...
membersFlow.navigationOptions = {
  title: 'Members',
  tabBarIcon: <MaterialCommunityIcons name="wallet-membership" size={20} testID='membersNavigationImagen'/>,
